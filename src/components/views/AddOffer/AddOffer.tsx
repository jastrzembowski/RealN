...
export default function AddOffer() {
  ...
  const recreationChange = (event:any) => {
    event.preventDefault();
  ...
  const amenitiesChange = (event:any) => {
    event.preventDefault();
  ...
  const furnitureChange = (event:any) => {
    event.preventDefault();
  ...
  const bathroomChange = (event:any) => {
    event.preventDefault();
  ...
  const directionChange = (event:any) => {
    event.preventDefault();
              ...
              <article>
                ...
                <div>
                  ...
                  <motion.button
                    ...
                    onClick={transportChange}
                    className={
                      transport.includes("metro") ? "button-selected" : ""
                    }
                  >
                    metro
                  </motion.button>
                  <motion.button
                    ...
                    onClick={transportChange}
                    className={
                      transport.includes("PKP") ? "button-selected" : ""
                    }
                  >
                    PKP
                  </motion.button>
                  <motion.button
                    ...
                    onClick={transportChange}
                    className={
                      transport.includes("PKS") ? "button-selected" : ""
                    }
                  >
                    PKS
                  </motion.button>
