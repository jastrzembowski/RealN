        ...
        <form>
          ...
          <article>
            ...
            <div>
              <motion.button
                ...
                className={
                  transport.includes("autobus") ? "button-selected" : ""
                }
              >
                autobus
              </motion.button>
              <motion.button
                ...
                onClick={transportChange}
                className={
                  transport.includes("tramwaj") ? "button-selected" : ""
                }
              >
                tramwaj
              </motion.button>
              <motion.button
                ...
                onClick={transportChange}
                className={
                  transport.includes("trolejbus") ? "button-selected" : ""
                }
              >
                trolejbus
              </motion.button>
              <motion.button
                ...
                onClick={transportChange}
                className={
                  transport.includes("kolej podmiejska")
                    ? "button-selected"
                    : ""
                }
              >
              ...
              <motion.button
                ...
                value={"metro"}
                onClick={transportChange}
                className={transport.includes("metro") ? "button-selected" : ""}
              >
                metro
              </motion.button>
              <motion.button
                ...
                value={"pkp"}
                onClick={transportChange}
                className={transport.includes("PKP") ? "button-selected" : ""}
              >
                PKP
              </motion.button>
              <motion.button
                ...
                value={"pks"}
                onClick={transportChange}
                className={transport.includes("PKS") ? "button-selected" : ""}
              >
                PKS
              </motion.button>
              <motion.button
                ...
                onClick={transportChange}
                className={
                  transport.includes("lotnisko") ? "button-selected" : ""
                }
              >
                lotnisko
              </motion.button>
            ...
            <div>
              ...
              <motion.button
                ...
                onClick={educationChange}
                className={
                  education.includes("szkoła średnia") ? "button-selected" : ""
                }
              >
                szkoła średnia
              </motion.button>{" "}
            ...
            <div>
              <motion.button
                ...
                className={health.includes("szpital") ? "button-selected" : ""}
              >
                przychodnia / szpital
              </motion.button>{" "}
              <motion.button
                ...
                value={"apteka"}
                onClick={healthChange}
                className={health.includes("apteka") ? "button-selected" : ""}
              >
                apteka
              </motion.button>
              <motion.button
            ...
            <div>
              ...
              <motion.button
                ...
                value={"park"}
                onClick={recreationChange}
                className={recreation.includes("park") ? "button-selected" : ""}
              >
                park{" "}
              </motion.button>
              <motion.button
                ...
                value={"las"}
                onClick={recreationChange}
                className={recreation.includes("las") ? "button-selected" : ""}
              >
                las
              </motion.button>{" "}
              <motion.button
            ...
            <div>
              <motion.button
                ...
                className={
                  others.includes("centrum handlowe") ? "button-selected" : ""
                }
              >
                centrum handlowe
              </motion.button>
              <motion.button
                ...
                value={"sklep"}
                onClick={othersChange}
                className={others.includes("sklep") ? "button-selected" : ""}
              >
                sklep{" "}
              </motion.button>
              <motion.button
                ...
                value={"bazarek"}
                onClick={othersChange}
                className={others.includes("bazarek") ? "button-selected" : ""}
              >
                bazarek
              </motion.button>
            </div>
            ...
            <div>
              <motion.button
                ...
                className={amenities.includes("winda") ? "button-selected" : ""}
              >
                winda
              </motion.button>{" "}
              <motion.button
                ...
                onClick={amenitiesChange}
                className={
                  amenities.includes("teren zamknięty") ? "button-selected" : ""
                }
              >
                teren zamknięty
              </motion.button>
              ...
              <motion.button
                ...
                value={"patio"}
                onClick={amenitiesChange}
                className={amenities.includes("patio") ? "button-selected" : ""}
              >
                patio
              </motion.button>{" "}
              <motion.button
          ...
          <article>
            ...
            <div className="flex-row">
              ...
              <div style={{ width: "49%", margin: "5px" }}>
                ...
                <motion.button
                  ...
                  value={"wanna"}
                  onClick={bathroomChange}
                  className={bathAm.includes("wanna") ? "button-selected" : ""}
                >
                  wanna
                </motion.button>{" "}
                <motion.button
            ...
            <div className="flex-row">
              ...
              <div style={{ marginLeft: "5px" }}>
                ...
                <motion.button
                  ...
                  onClick={furnitureChange}
                  className={
                    furnitured.includes("częściowo") ? "button-selected" : ""
                  }
                >
                  częściowo
                </motion.button>
            ...
            <motion.button
              ...
              value={"CO własne"}
              onClick={energyChange}
              className={energy.includes("CO własne") ? "button-selected" : ""}
            >
              CO własne{" "}
            </motion.button>
            <motion.button
              ...
              value={"biomasa"}
              onClick={energyChange}
              className={energy.includes("biomasa") ? "button-selected" : ""}
            >
              biomasa{" "}
            </motion.button>{" "}
            <motion.button
              ...
              value={"podłogowe"}
              onClick={energyChange}
              className={energy.includes("podłogowe") ? "button-selected" : ""}
            >
              podłogowe
            </motion.button>
            <motion.button
              ...
              value={"geotermika"}
              onClick={energyChange}
              className={energy.includes("geotermika") ? "button-selected" : ""}
            >
              geoterminka
            </motion.button>
            <motion.button
            ...
            <motion.button
              ...
              value={"kominkowe"}
              onClick={energyChange}
              className={energy.includes("kominkowe") ? "button-selected" : ""}
            >
              kominkowe
            </motion.button>{" "}
            <motion.button
              ...
              value={"słoneczne"}
              onClick={energyChange}
              className={energy.includes("słoneczne") ? "button-selected" : ""}
            >
              słoneczne
            </motion.button>
            <motion.button
              ...
              value={"węglowe"}
              onClick={energyChange}
              className={energy.includes("węglowe") ? "button-selected" : ""}
            >
              węglowe
            </motion.button>{" "}
            <motion.button
              ...
              value={"olejowe"}
              onClick={energyChange}
              className={energy.includes("olejowe") ? "button-selected" : ""}
            >
              olejowe
            </motion.button>
            <motion.button
            ...
            <motion.button
              ...
              value={"internet"}
              onClick={mediaChange}
              className={media.includes("internet") ? "button-selected" : ""}
            >
              internet
            </motion.button>
            <motion.button
            ...
            <motion.button
              ...
              className={direction.includes("północ") ? "button-selected" : ""}
            >
              północne
            </motion.button>
            <motion.button
            ...
            <motion.button
              ...
              value={"wschód"}
              onClick={directionChange}
              className={direction.includes("wschód") ? "button-selected" : ""}
            >
              wschodnie
            </motion.button>{" "}
            <motion.button
              ...
              value={"zachód"}
              onClick={directionChange}
              className={direction.includes("zachód") ? "button-selected" : ""}
            >
              zachodnie
            </motion.button>
          </article>
